...
import com.lukasstancikas.zedge_photos_details.ui.FullScreenScaffold
import com.lukasstancikas.zedge_photos_details.ui.LoadableContent
...
@Composable
fun PhotoListContent(photos: List<Photo>) {
    LazyColumn(
